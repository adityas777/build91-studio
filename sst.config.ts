  ...
  async run() {
    ...
    new sst.aws.Nextjs("MyWeb", {
      ...
      environment: {
        ...
        GOOGLE_SHEETS_FEEDBACK_WEBHOOK_URL: process.env.GOOGLE_SHEETS_FEEDBACK_WEBHOOK_URL || "https://script.google.com/macros/s/AKfycby_XLoWNH_ky_cpuBERTD3la-nbNH_Ed7d-15bcDiJZCVwK0GxWsvipQSGbk3v31iBb/exec",
      },
    });
  },
});
